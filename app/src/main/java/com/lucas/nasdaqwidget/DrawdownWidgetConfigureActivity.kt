...
class DrawdownWidgetConfigureActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(TextView(this).apply {
            text = "Drawdown depuis l'ATH"
            textSize = 25f
            setTextColor(Color.WHITE)
            setTypeface(typeface, Typeface.BOLD)
        })
        root.addView(TextView(this).apply {
            text = "Choisis l'actif à suivre"
            textSize = 14f
        ...
        root.addView(Button(this).apply {
            ...
            setOnClickListener {
                ...
                WidgetAssetConfig.save(this@DrawdownWidgetConfigureActivity, appWidgetId, raw, name)
                val manager = AppWidgetManager.getInstance(this@DrawdownWidgetConfigureActivity)
                DrawdownWidgetProvider.updateOne(this@DrawdownWidgetConfigureActivity, manager, appWidgetId)
